  ...
  if (isSseMode) {
    ...
    app.get('/api/search', async (req, res) => {
      try {
        ...
        const uploadDate = req.query.uploadDate as string | undefined;
    ...
    app.get('/api/transcript', async (req, res) => {
      try {
        ...
        const format = req.query.format as 'text' | 'segments' | 'both' | undefined;
        const startTime = req.query.startTime ? parseFloat(req.query.startTime as string) : undefined;
        const endTime = req.query.endTime ? parseFloat(req.query.endTime as string) : undefined;
        const maxSegments = req.query.maxSegments ? parseInt(req.query.maxSegments as string, 10) : undefined;
    ...
    app.get('/api/video-info', async (req, res) => {
      try {
        const videoId = req.query.videoId as string;
        const detail = req.query.detail as 'brief' | 'standard' | 'full' | undefined;
    ...
    app.post('/api/clip', async (req, res) => {
      try {
        ...
        const makeRelative = (absolutePath: string) => {
